/* the brand palette as hex constants for inline svg — mirrors the
   @theme tokens in app/globals.css (see GUIDELINES.md). */
...
export const MIST = "#e2e8f0";
export const INK = "#1e293b";
export const SKY_LIGHT = "#c9d7ee";
...
export const SPACE_DARK = "#0d1b2a";
export const SPACE_LIGHT = "#2f2f9e";
export const SUN = "#ffd166";
export const FLARE = "#ff2b2b";
export const STROKE = "#0a0e1a";
