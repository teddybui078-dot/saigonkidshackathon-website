...
/* the hero: six layers deep, composed here in z order. this file owns
   the motion — the entrance, the logo's idle drift and the parallax on
   the art — and nothing else. the readable layer never scrubs. */
